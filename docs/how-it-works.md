...
| Bind           | Offer facts, a control's options, deterministic goal spans, or page-derived values.               | Pick one supplied value or `none`.                | The model never writes field contents.                                                                                |
...
| Act            | Send one JSON-lines command to the Node child.                                                    | None.                                             | Chromium clicks, fills, selects, scrolls, finds, or types.                                                            |
